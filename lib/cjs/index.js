...
var OpthysView_metadata_json_1 = __importDefault(require("./OpthysView_metadata.json"));
var ChainId;
(function (ChainId) {
    ChainId[ChainId["RinkebyTestnet"] = 4] = "RinkebyTestnet";
    ChainId[ChainId["GodwokenTestnet"] = 71393] = "GodwokenTestnet";
})(ChainId = exports.ChainId || (exports.ChainId = {}));
exports.ERC20 = function (chainId) {
    var ABI = IERC20Metadata_metadata_json_1.default.output.abi;
...
exports.OpthyABI = function (_chainId) {
    return Opthy_metadata_json_1.default.output.abi;
};
exports.Opthys = function (chainId) {
    var ABI = Opthys_metadata_json_1.default.output.abi;
    if (ChainId.RinkebyTestnet == chainId) {
        return {
...
exports.OpthysView = function (chainId) {
    var ABI = OpthysView_metadata_json_1.default.output.abi;
    if (ChainId.RinkebyTestnet == chainId) {
        return {
